...
void mescla(int array[], int init_left, int tail_left, int init_right,
            int tail_right) {
...
void merge_sort(int array[], int init_array, int sizearray) {
  int left_array[sizearray], right_array[sizearray], init_left = 0,
                                                     init_right = 0;
...
IntervalMaxSubarray max_subarray(int array[], int init_array, int size_array) {
  ...
  if (mid > init_array) {
    ...
    if (maxleftarray.sum > maxrightarray.sum &&
        maxleftarray.sum > maxacrossarray.sum) {
      return maxleftarray;
    } else if (maxrightarray.sum > maxleftarray.sum &&
               maxrightarray.sum > maxacrossarray.sum) {
