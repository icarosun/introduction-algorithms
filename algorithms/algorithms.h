...
void insertion_sort_with_search_minus_value(int array[],
                                            int sizearray);   // exercise 2.2-2
...
int binary_search_recursive(int array[], int left, int right,
                            int key); // exercise 2.3-5
void insertion_sort_with_binary_search(int array[],
                                       int sizearray); // exercise 2.3-6
bool sum_of_two_numbers(int array[], int sizearray,
                        int result); // exercise 2.3-7
bool sum_of_two_numbers_v2(int array[], int sizearray,
                           int result); // exercise 2.3-7
void bubble_sort(int array[], int sizearray);
IntervalMaxSubarray max_subarray(int array[], int init_array, int size_array);
IntervalMaxSubarray max_middle_subarray(int array[], int init_array, int mid,
                                        int size_array);
...
public:
  HeapSort(int array[], int size_array);
  int left(int index);
  int right(int index);
